      ...
      <Container as={Stack} maxW={'6xl'} py={10}>
        <SimpleGrid columns={{ base: 2, sm: 2, md: 4 }} spacing={8}>
          <Stack align={'flex-start'}>
            ...
            <Link href={'#'} _hover={{color:"red"}} style={{color:"white"}}>KFC Food</Link>
            <Stack direction={'row'} align={'center'} spacing={2}>
              <Link href={'#'} style={{color:"white"}}>Menu</Link>
            </Stack>
            <Link href={'#'} style={{color:"white"}}>Order Lookup</Link>
            <Link href={'#'} style={{color:"white"}}>Gift Card</Link>
            <Link href={'#'} style={{color:"white"}}>Nutrition & Allergen</Link>
            <Link href={'#'} style={{color:"white"}}>Support</Link>
            <Link href={'#'} style={{color:"white"}}>Get Help</Link>
          ...
          <Stack align={'flex-start'}>
            ...
            <Link href={'#'} style={{color:"white"}}>KFC Feedback</Link>
            <Link href={'#'} style={{color:"white"}}>Privacy Policy</Link>
            <Link href={'#'} style={{color:"white"}}>Legal</Link>
            <Link href={'#'} style={{color:"white"}}>Terms and Conditions</Link>
            <Link href={'#'} style={{color:"white"}}>Disclaimer</Link>
            <Link to="/adminlogin" style={{color:"white"}}>Admin Page</Link>
          ...
          <Stack align={'flex-start'}>
            ...
            <Link href={'#'} style={{color:"white"}}>KFC India</Link>
            <Link href={'#'} style={{color:"white"}}>About KFC</Link>
            <Link href={'#'} style={{color:"white"}}>Careers</Link>
          </Stack>
        </SimpleGrid>
      </Container>
      <Box py={10}>
